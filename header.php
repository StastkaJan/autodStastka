...
<html lang="cs">
	<head>
        ...
        <link href="<?php echo get_template_directory_uri(); ?>/img/scaniaLogo.ico" rel="shortcut icon">
        <link href="<?php echo get_template_directory_uri(); ?>/img/scaniaLogo.ico" rel="apple-touch-icon-precomposed">
